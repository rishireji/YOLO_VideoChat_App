  ...
  return (
    <div className="relative w-full bg-black">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen px-4 text-center overflow-hidden">
        <div className={`relative z-10 flex flex-col items-center max-w-4xl w-full py-20 transition-all duration-1000 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <div className={`max-w-md mx-auto bg-zinc-950/40 backdrop-blur-3xl border border-white/10 p-8 rounded-[40px] shadow-[0_30px_100px_rgba(0,0,0,0.8)] space-y-6 transition-all duration-1000 delay-300 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 py-32 grid md:grid-cols-3 gap-8">
        {[
          ...
          <div key={idx} className="bg-zinc-950/40 backdrop-blur-3xl border border-white/5 p-10 rounded-[48px] hover:border-red-500/30 transition-all hover:-translate-y-2 group shadow-2xl">
      ...
      <section id="faq-section" className="relative z-10 max-w-4xl mx-auto px-6 pb-32 pt-10">
        ...
        <div className="bg-zinc-950/40 border border-white/5 rounded-[56px] p-8 md:p-16 backdrop-blur-3xl shadow-inner">
          {faqs.map((faq, index) => (
